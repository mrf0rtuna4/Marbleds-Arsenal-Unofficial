...
import net.marblednull.marbledsarsenal.client.renderer.AzaleaGhillieArmorRenderer;
...
public class AzaleaGhillieArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public AzaleaGhillieArmorItem(
