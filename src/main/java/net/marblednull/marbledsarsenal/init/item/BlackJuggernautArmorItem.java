...
import net.marblednull.marbledsarsenal.client.renderer.BlackJuggernautArmorRenderer;
...
public class BlackJuggernautArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public BlackJuggernautArmorItem(
